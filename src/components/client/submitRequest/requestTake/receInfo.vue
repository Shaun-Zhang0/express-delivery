 ...
 * @Last Modified time: 2019-05-23 18:11:33
 */
<template>
  <div>
    ...
    <el-dialog title="选择收货地址" :visible.sync="dialogVisible" width="60%">
      <get-rec-location @sendMsg="getMsg"></get-rec-location>
    </el-dialog>
  </div>
</template>
<style scoped>
...
<script>
import getRecLocation from "./../map/getRecLocation";
export default {
  components: { getRecLocation: getRecLocation },
  data() {
    return {
      secondStep: {
        recAddress: "", // 收货地址
